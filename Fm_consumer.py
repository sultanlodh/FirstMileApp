...
class KafkaConsumer:
    def __init__(self, consumer_settings, consumer_topic, dest_settings, source_connection,
        ...
        self.foc_consigments = 'fact_consignment_fm'
                ...
                with closing(connection.cursor()) as cursor:
                   if foc_pickup_customer_code is not None:
                    consignment_sql = f"""update {foc_consigments_tbl} 
                                          set foc_pickup_customer_code = '{foc_pickup_customer_code}', ModifiedTs = '{ModifiedTs}', ModifiedBy = '{ModifiedBy}' 
    ...
    def history_table_custom_updates(self, foc_consigments_tbl, table_name, df, message_value):
        try:
            ...
            if foc_pickup_attempt2_date is not None:
                select_sql = f"""select foc_pickup_attempt2_date from {foc_consigments_tbl} where foc_cnno = '{foc_cnno}'
            ...
            if foc_pickup_attempt3_date is not None:
                select_sql = f"""select foc_pickup_attempt3_date from {foc_consigments_tbl} where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup_scheduled2_date is not None:
                select_sql = f"""select foc_pickup_scheduled2_date from {foc_consigments_tbl} where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup_scheduled3_date is not None:
                select_sql = f"""select foc_pickup_scheduled3_date from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup_reassigned2_date is not None:
                select_sql = f"""select foc_pickup_reassigned2_date from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup_reassigned3_date is not None:
                select_sql = f"""select foc_pickup_reassigned3_date from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup2_remarks is not None:
                select_sql = f"""select foc_pickup2_remarks from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup3_remarks is not None:
                select_sql = f"""select foc_pickup3_remarks from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup_npr_reason is not None:
                select_sql = f"""select foc_pickup_npr_reason from {foc_consigments_tbl}
                                 where foc_cnno = '{foc_cnno}' 
                                 and foc_pickup_attempt_date is null"""  
                dest_cursor.execute(select_sql)
                row_value = dest_cursor.fetchall()
            ...
            if foc_pickup_npr2_reason is not None:
                select_sql = f"""select foc_pickup_npr2_reason from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' 
            ...
            if foc_pickup_npr3_reason is not None:
                select_sql = f"""select foc_pickup_npr3_reason from {foc_consigments_tbl} 
            ...
            if foc_pickup_cancelled2_date is not None:
                select_sql = f"""select foc_pickup_cancelled2_date from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' and
            ...
            if foc_pickup_cancelled3_date is not None:
                select_sql = f"""select foc_pickup_cancelled3_date from {foc_consigments_tbl} 
                                 where foc_cnno = '{foc_cnno}' 
