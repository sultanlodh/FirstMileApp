config = {
    ...
    "Booking_Details_Final_Schema": ['foc_cnno', 'foc_cpdp_code','foc_bkcusttype_code','foc_bkcust_code','foc_bookchannel','foc_bkdocument_code','foc_Booked_Wt','foc_Vol_Wt','foc_Billed_Wt','foc_pcs','foc_nop','foc_booking_app', 'foc_content_desc'],
